  ...
  return (
    <div>
      ...
      <div className="md:flex justify-center items-center gap-4">
        <div className="bg-portfolio-gray md:w-1/3 rounded-xl aspect-square">
          ...
          <div className="p-3">
            ...
            <a
              className="text-portfolio-secondary bg-[#3A3A3A] border-[#3A3A3A] border-2  py-1 md:px-4 rounded-[5px] hover:bg-[#525252]"
